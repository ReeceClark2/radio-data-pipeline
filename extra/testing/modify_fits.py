...
def update_obsfreq_in_folder(input_dir: str, output_dir: str, new_obsfreq: float):
    ...
    for file in fits_files:
        with fits.open(file) as hdul:
            ...
            print('  CRVAL2 (data):', type(hdul[1].data['CRVAL2']), hdul[1].data['CRVAL2'])
            print('  CRVAL3 (data):', type(hdul[1].data['CRVAL3']), hdul[1].data['CRVAL3'])
...
update_obsfreq_in_folder("C:/Users/starb/OneDrive/Desktop/SUMMER-2025/mike/radio-data-pipeline/data/one_file", "C:/Users/starb/OneDrive/Desktop/SUMMER-2025/mike/radio-data-pipeline/data/one_file_mod", 1395)
