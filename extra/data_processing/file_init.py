...
if __name__ == "__main__":
    ...
    file = Radio_File("C:/Users/starb/Downloads/0117689.fits")

    calstate_array = np.array(file.data['CALSTATE'])
    swpvalid_array = np.array(file.data['SWPVALID'])

    # Now these are plain NumPy ndarrays
    np.set_printoptions(threshold=np.inf)
    print(calstate_array[0:100])
    print(swpvalid_array[0:100])
