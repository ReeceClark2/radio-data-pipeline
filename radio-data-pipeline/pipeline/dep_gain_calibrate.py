            ...
            for j in plnums:
                ...
                for h in range(first_len):
                    if pre_cal_deltas[h] and post_cal_deltas[h]:
                        pre_cal_delta = 6 #average_neighbors(pre_cal_deltas, h, 5)
                        post_cal_delta = 6 # average_neighbors(post_cal_deltas, h, 5)
                    ...
                    print(f"IFNUM={i}, PLNUM={j}, CH={h} → pre={pre_cal_delta}±{pre_cal_unc}, post={post_cal_delta}±{post_cal_unc}")
